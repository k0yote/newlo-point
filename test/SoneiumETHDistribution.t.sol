...
contract SoneiumETHDistributionTest is Test {
    ...
    function testAntiDuplicateMode() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                SoneiumETHDistribution.DuplicateDistribution.selector,
                user1,
                block.timestamp
            )
        );
    ...
    function testInvalidBatchSize() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                SoneiumETHDistribution.InvalidBatchSize.selector,
                501,
                500
            )
        );
    ...
    function testZeroAddress() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                SoneiumETHDistribution.ZeroAddress.selector,
                0
            )
        );
        distribution.distributeEqual(recipients, DISTRIBUTION_AMOUNT);
    ...
    function testZeroAmount() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                SoneiumETHDistribution.ZeroAmount.selector,
                0
            )
        );
    ...
    function testArrayLengthMismatch() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                SoneiumETHDistribution.ArrayLengthMismatch.selector,
                2,
                1
            )
        );
    ...
    function testLargeScaleDistribution() public {
        ...
        for (uint i = 0; i < 10; i++) { // Check first 10 recipients
    ...
    function testEmergencyRecipientFunctionality() public {
        ...
        vm.prank(depositManager);
        vm.expectRevert(
            abi.encodeWithSelector(SoneiumETHDistribution.UnauthorizedEmergencyRecipient.selector, user1)
        );
